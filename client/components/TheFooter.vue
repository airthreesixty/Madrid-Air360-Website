      ...
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="https://flowbite.com" class="flex items-center">
            <nuxt-img :src="logo" format="webp" />
          </a>
        </div>
        <div class="grid grid-cols-1 gap-8 gap-6 md:grid-cols-3">
          <div v-for="column in footerData.columns" :key="column">
            <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-white">
              {{ column.title }}
            </h2>
            <ul class="text-black-700 dark:text-gray-400">
...
console.log(footerData.columns)
</script>
